...
export function AIIntelligencePanel({ projectId }: { projectId: string }) {
  ...
  const { summary, alerts = [], suggestions = [], velocityScore, nextBigMove } = insights;
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {alerts.map((alert: any) => (
                  <div key={alert.id || alert.message} className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-start gap-3">
                    <div className={cn(
