  ...
  return (
    <section className="py-32 bg-white dark:bg-slate-950">
      <div className="container px-6 mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-7xl font-display font-black text-slate-950 dark:text-white leading-[1.1] tracking-tighter">
        ...
        >
          {features.map((feature) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-slate-950 dark:text-white mb-4 tracking-tight">
                {feature.title}
              </h3>
